...
class ListaReproduccionForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'fecha_subida': forms.DateInput(format='%Y-%m-%d', attrs={
            ...
            'hora_subida': forms.TextInput(attrs={'class': 'form-control', 'autocomplete': 'off'}),
        }
