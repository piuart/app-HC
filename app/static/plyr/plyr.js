"object" == typeof navigator && function (e, t) {
    ...
    var o = function (e) {
        ...
        nullOrUndefined: l, object: c, number: function (e) {
            return o(e) === Number && !Number.isNaN(e)
        }, string: u, boolean: function (e) {
            return o(e) === Boolean
        }, function: function (e) {
            return o(e) === Function
        }, array: d, weakMap: function (e) {
            return r(e, WeakMap)
        }, nodeList: h, element: function (e) {
            return r(e, Element)
        }, textNode: function (e) {
            return o(e) === Text
        }, event: function (e) {
    ...
    function g(e, t, n) {
        ...
        if (e && "addEventListener" in e && !m.empty(t) && m.function(n)) {
            var r = t.split(" "), l = o;
            f && (l = {passive: s, capture: o}), r.forEach(function (t) {
    ...
    function C(e) {
        if (m.element(e)) for (var t = e.childNodes.length; t > 0;) e.removeChild(e.lastChild), t -= 1
    }
    ...
    function M(e, t) {
        ...
        return e.split(",").forEach(function (e) {
            var t = e.trim(), a = t.replace(".", ""), s = t.replace(/[[\]]/g, "").split("="), o = s[0],
    ...
    var H, F = {
        ...
        check: function (e, t, n) {
            var i = F.isIPhone && n && z.playsinline, a = z[e] || "html5" !== t;
            return {api: a, ui: a && z.rangeInput && ("video" !== e || !F.isIPhone || i)}
        },
            ...
            if (this.isHTML5) {
                ...
                Object.defineProperty(e.media, "quality", {
                    get: function () {
                        ...
                        if (n) {
                            var i = e.media, a = i.currentTime, s = i.paused, o = i.preload, r = i.readyState;
                            e.media.src = n.getAttribute("src"), ("none" !== o || r) && (e.once("loadedmetadata", function () {
                                e.currentTime = a, s || e.play()
                            }), e.media.load()), k.call(e, e.media, "qualitychange", !1, {quality: t})
                        }
                    }
                })
            }
    ...
    var ee = {pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube"}, te = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "",
            t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
    ...
    function ae(e, t) {
        if (m.string(e)) {
            var n = m.string(t), i = function () {
                return null !== document.getElementById(t)
            }, a = function (e, t) {
                e.innerHTML = t, n && i() || document.body.insertAdjacentElement("afterbegin", e)
            };
            if (!n || !i()) {
                var s = ne.supported, o = document.createElement("div");
                ...
                ie(e).then(function (e) {
                    m.empty(e) || (s && window.localStorage.setItem("".concat("cache", "-").concat(t), JSON.stringify({content: e})), a(o, e))
                }).catch(function () {
                })
            }
        }
    ...
    var ce = {
        getIconUrl: function () {
            ...
            var n = ce.getIconUrl.call(this), i = "".concat(n.cors ? "" : n.url, "#").concat(this.config.iconPrefix),
                a = document.createElementNS("http://www.w3.org/2000/svg", "svg");
            T(a, J(t, {role: "presentation", focusable: "false"}));
            var s = document.createElementNS("http://www.w3.org/2000/svg", "use"), o = "".concat(i, "-").concat(e);
            ...
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = te(e, this.config);
            ...
            return t.appendChild(A("span", {class: this.config.classNames.menu.badge}, e)), t
        }, createButton: function (e, t) {
            var n = Object.assign({}, t), i = X(e),
            ...
            if ("volume" !== e) {
                ...
                var i = {played: "played", buffer: "buffered"}[e], a = i ? te(i, this.config) : "";
                n.innerText = "% ".concat(a.toLowerCase())
            }
            return this.elements.display[e] = n, n
        }, createTime: function (e) {
            var t = M(this.config.selectors.display[e]), n = A("div", J(t, {
            ...
            y(e, "keydown keyup", function (i) {
                if ([32, 38, 39, 40].includes(i.which) && (i.preventDefault(), i.stopPropagation(), "keydown" !== i.type)) {
                    ...
                    if (!s && [32, 39].includes(i.which)) ce.showMenuPanel.call(n, t, !0); else 32 !== i.which && (40 === i.which || s && 39 === i.which ? (a = e.nextElementSibling, m.element(a) || (a = e.parentNode.firstElementChild)) : (a = e.previousElementSibling, m.element(a) || (a = e.parentNode.lastElementChild)), O.call(n, a, !0))
                }
            }, !1), y(e, "keyup", function (e) {
                13 === e.which && ce.focusFirstMenuItem.call(n, null, !0)
            })
        }, createMenuItem: function (e) {
            var t = this, n = e.value, i = e.list, a = e.type, s = e.title, o = e.badge, r = void 0 === o ? null : o,
                l = e.checked, c = void 0 !== l && l, u = M(this.config.selectors.inputs[a]), d = A("button", J(u, {
                    type: "button",
                    role: "menuitemradio",
            ...
            if (this.supported.ui && m.event(e)) {
                ...
                if (e) switch (e.type) {
                    ...
                    case"progress":
                        !function (e, n) {
                            var i = m.number(n) ? n : 0, a = m.element(e) ? e : t.elements.display.buffer;
                            if (m.element(a)) {
                                a.value = i;
            ...
            if (m.element(t) && "range" === t.getAttribute("type")) {
                if (I(t, this.config.selectors.inputs.seek)) {
                    ...
                    var n = ce.formatTime(this.currentTime), i = ce.formatTime(this.duration),
            ...
            if (this.config.tooltips.seek && m.element(this.elements.inputs.seek) && m.element(this.elements.display.seekTooltip) && 0 !== this.duration) {
                var n = 0, i = this.elements.progress.getBoundingClientRect(),
                    a = "".concat(this.config.classNames.tooltip, "--visible"), s = function (e) {
                        L(t.elements.display.seekTooltip, a, e)
                    };
                if (this.touch) s(!1); else {
                    if (m.event(e)) n = 100 / i.width * (e.pageX - i.left); else {
            ...
            if (m.element(this.elements.settings.panels.captions)) {
                var t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                    n = he.getTracks.call(this), i = Boolean(n.length);
            ...
            var e = this.elements.settings.buttons, t = !m.empty(e) && Object.values(e).some(function (e) {
                return !e.hidden
            });
            ...
            if (m.element(t) && m.element(n)) {
                var i = t.hidden, a = i;
                if (m.boolean(e)) a = e; else if (m.keyboardEvent(e) && 27 === e.which) a = !1; else if (m.event(e)) {
            ...
            var t = this, n = A("div", M(this.config.selectors.controls.wrapper));
            ...
            if (this.config.controls.includes("captions") && n.appendChild(ce.createButton.call(this, "captions")), this.config.controls.includes("settings") && !m.empty(this.config.settings)) {
                ...
                var l = A("div", {class: "plyr__menu__container", id: "plyr-settings-".concat(e.id), hidden: ""}),
                    c = A("div"), u = A("div", {id: "plyr-settings-".concat(e.id, "-home")}),
                    d = A("div", {role: "menu"});
                u.appendChild(d), c.appendChild(u), this.elements.settings.panels.home = u, this.config.settings.forEach(function (n) {
                    ...
                    var a = A("span", null, te(n, t.config)), s = A("span", {class: t.config.classNames.menu.value});
                    s.innerHTML = e[n], a.appendChild(s), i.appendChild(a), d.appendChild(i);
                    var o = A("div", {id: "plyr-settings-".concat(e.id, "-").concat(n), hidden: ""}), r = A("button", {
                        type: "button",
                        class: "".concat(t.config.classNames.control, " ").concat(t.config.classNames.control, "--back")
                    });
                    r.appendChild(A("span", {"aria-hidden": !0}, te(n, t.config))), r.appendChild(A("span", {class: t.config.classNames.hidden}, te("menuBack", t.config))), y(o, "keydown", function (e) {
                    ...
                    }), o.appendChild(r), o.appendChild(A("div", {role: "menu"})), c.appendChild(o), t.elements.settings.buttons[n] = i, t.elements.settings.panels[n] = o
            ...
            if (this.config.controls.includes("pip") && z.pip && n.appendChild(ce.createButton.call(this, "pip")), this.config.controls.includes("airplay") && z.airplay && n.appendChild(ce.createButton.call(this, "airplay")), this.config.controls.includes("download")) {
                var h = {element: "a", href: this.download, target: "_blank"}, p = this.config.urls.download;
            ...
            if (window.navigator.userAgent.includes("Edge") && V(o), this.config.tooltips.controls) {
                var c = this.config, u = c.classNames, d = c.selectors,
                    h = "".concat(d.controls.wrapper, " ").concat(d.labels, " .").concat(u.hidden), p = _.call(this, h);
    ...
    var he = {
            setup: function () {
                if (this.supported.ui) if (!this.isVideo || this.isYouTube || this.isHTML5 && !z.textTracks) m.array(this.config.controls) && this.config.controls.includes("settings") && this.config.settings.includes("captions") && ce.setCaptionsMenu.call(this); else {
                    var e, t;
                    if (m.element(this.elements.captions) || (this.elements.captions = A("div", M(this.config.selectors.captions)), e = this.elements.captions, t = this.elements.wrapper, m.element(e) && m.element(t) && t.parentNode.insertBefore(e, t.nextSibling)), F.isIE && window.URL) {
                        ...
                        Array.from(n).forEach(function (e) {
                            var t = e.getAttribute("src"), n = ue(t);
                ...
                var e = this, t = he.getTracks.call(this, !0), n = this.captions, i = n.active, a = n.language, s = n.meta,
                    o = n.currentTrackNode, r = Boolean(t.find(function (e) {
                        return e.language === a
                    }));
                this.isHTML5 && this.isVideo && t.filter(function (e) {
                    return !s.get(e)
                }).forEach(function (t) {
                    e.debug.log("Track added", t), s.set(t, {default: "showing" === t.mode}), t.mode = "hidden", y.call(e, t, "cuechange", function () {
                ...
                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = he.getTracks.call(this);
                if (-1 !== e) if (m.number(e)) if (e in n) {
                ...
                } else this.debug.warn("Track not found", e); else this.debug.warn("Invalid caption argument", e); else he.toggle.call(this, !1, t)
            }, setLanguage: function (e) {
                var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
                if (m.string(e)) {
                    var n = e.toLowerCase();
                    this.captions.language = n;
                    var i = he.getTracks.call(this), a = he.findTrack.call(this, [n]);
                ...
                var t, n = this, i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                    a = he.getTracks.call(this), s = function (e) {
                ...
                if (this.supported.ui) if (m.element(this.elements.captions)) if (m.nullOrUndefined(e) || Array.isArray(e)) {
                    var t = e;
                    if (!t) {
        ...
        }, me = "picture-in-picture", fe = "inline", ge = {html5: "html5", youtube: "youtube", vimeo: "vimeo"},
        ...
        if (this.enabled) {
            ...
            m.element(e) && (e.pressed = this.active), k.call(this.player, this.target, this.active ? "enterfullscreen" : "exitfullscreen", !0), F.isIos || function () {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                    t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                if (m.element(e)) {
                    var n = _.call(this, "button:not(:disabled), input:not(:disabled), [tabindex]"), i = n[0],
                        a = n[n.length - 1];
    ...
    var Te = function () {
        ...
        return n(t, [{
            ...
            key: "exit", value: function () {
                if (this.enabled) if (F.isIos && this.player.config.fullscreen.iosNative) this.target.webkitExitFullscreen(), this.player.play(); else if (t.native) if (this.prefix) {
                    if (!m.empty(this.prefix)) {
                        var e = "moz" === this.prefix ? "Cancel" : "Exit";
                        document["".concat(this.prefix).concat(e).concat(this.property)]()
                    }
                } else (document.cancelFullScreen || document.exitFullscreen).call(document); else we.call(this, !1)
            }
        }, {
    ...
    var Ee = {
        addStyleHook: function () {
            ...
            }, 0), Ee.setTitle.call(this), this.poster && Ee.setPoster.call(this, this.poster, !1).catch(function () {
            ...
            if (m.string(this.config.title) && !m.empty(this.config.title) && (e += ", ".concat(this.config.title)), Array.from(this.elements.buttons.play || []).forEach(function (t) {
                ...
                var n = m.empty(this.config.title) ? "video" : this.config.title, i = te("frameTitle", this.config);
        ...
        return n(t, [{
            ...
            key: "media", value: function () {
                ...
                e.supported.ui && e.config.disableContextMenu && y.call(e, t.wrapper, "contextmenu", function (e) {
                    ...
                    ce.updateSetting.call(e, "speed"), e.storage.set({speed: e.speed})
            ...
            key: "bind", value: function (e, t, n, i) {
                var a = this, s = !(arguments.length > 4 && void 0 !== arguments[4]) || arguments[4], o = this.player,
                    r = o.config.listeners[i], l = m.function(r);
            ...
            key: "controls", value: function () {
                var e = this, t = this.player, n = t.elements, i = F.isIE ? "change" : "input";
                ...
                this.bind(n.inputs.seek, i, function (e) {
                    ...
                    var n = t.config, i = t.elements, a = t.timers;
                    ...
                    var n = e.webkitDirectionInvertedFromDevice, i = a([e.deltaX, -e.deltaY].map(function (e) {
                        return n ? -e : e
                    }), 2), s = i[0], o = i[1], r = Math.sign(Math.abs(s) > Math.abs(o) ? s : o);
    ...
    var Ce, Se = (function (e, t) {
        ...
        n = function () {
            ...
            function o(t, n, i, a) {
                var s, r, l = document, c = i.async, u = (i.numRetries || 0) + 1, d = i.before || e,
                    h = t.replace(/^(css|img)!/, "");
    ...
    var Le = {
        setup: function () {
            ...
            var a,
                s = (a = i, m.empty(a) ? null : m.number(Number(a)) ? a : a.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : a),
                o = A("iframe"), r = Q(t.config.urls.vimeo.iframe, s, n);
            o.setAttribute("src", r), o.setAttribute("allowfullscreen", ""), o.setAttribute("allowtransparency", ""), o.setAttribute("allow", "autoplay");
            var l = A("div", {poster: t.poster, class: t.config.classNames.embedContainer});
            ...
            Object.defineProperty(t.media, "currentTime", {
                get: function () {
                    ...
                    var n = t.embed, i = t.media, a = t.paused, s = t.volume, o = a && !n.hasPlayed;
    ...
    var Ie, _e = {
        setup: function () {
            ...
            if (m.empty(t) || !t.startsWith("youtube-")) {
                ...
                var i, a,
                    s = (i = n, m.empty(i) ? null : i.match(/^.*(youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=|&v=)([^#&?]*).*/) ? RegExp.$2 : i),
        ...
        setup: function () {
            this.media ? (L(this.elements.container, this.config.classNames.type.replace("{0}", this.type), !0), L(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), !0), this.isEmbed && L(this.elements.container, this.config.classNames.type.replace("{0}", "video"), !0), this.isVideo && (this.elements.wrapper = A("div", {class: this.config.classNames.video}), w(this.media, this.elements.wrapper), this.elements.poster = A("div", {class: this.config.classNames.poster}), this.elements.wrapper.appendChild(this.elements.poster)), this.isHTML5 ? W.extend.call(this) : this.isYouTube ? _e.setup.call(this) : this.isVimeo && Le.setup.call(this)) : this.debug.warn("No media element found!")
        }
    }, Oe = function () {
        function t(n) {
            var i = this;
        ...
        return n(t, [{
            ...
            key: "setupIMA", value: function () {
                this.elements.container = A("div", {class: this.player.config.classNames.ads}), this.player.elements.container.appendChild(this.elements.container), google.ima.settings.setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.ENABLED), google.ima.settings.setLocale(this.player.config.ads.language), this.elements.displayContainer = new google.ima.AdDisplayContainer(this.elements.container), this.requestAds()
            }
        }, {
            ...
            key: "onAdEvent", value: function (e) {
                var t = this, n = this.player.elements.container, i = e.getAd(), a = function (e) {
        ...
        insertElements: function (e, t) {
            var n = this;
            m.string(t) ? E(e, this.media, {src: t}) : m.array(t) && t.forEach(function (t) {
                E(e, n.media, t)
            })
        }, change: function (e) {
            var t = this;
            Y(e, "sources.length") ? (W.cancelRequests.call(this), this.destroy.call(this, function () {
                ...
                var n = e.sources, i = e.type, s = a(n, 1)[0], o = s.provider, r = void 0 === o ? ge.html5 : o,
                    l = s.src, c = "html5" === r ? i : "div", u = "html5" === r ? {} : {src: l};
                Object.assign(t, {
                    provider: r,
                    type: i,
        ...
        function t(n, i) {
            ...
            if (e(this, t), this.timers = {}, this.ready = !1, this.loading = !1, this.failed = !1, this.touch = z.touch, this.media = n, m.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || m.nodeList(this.media) || m.array(this.media)) && (this.media = this.media[0]), this.config = J({}, pe, t.defaults, i || {}, function () {
                ...
                speed: [],
                quality: []
            }, this.debug = new be(this.config.debug), this.debug.log("Config", this.config), this.debug.log("Support", z), !m.nullOrUndefined(this.media) && m.element(this.media)) if (this.media.plyr) this.debug.warn("Target already setup"); else if (this.config.enabled) if (z.check().api) {
                var s = this.media.cloneNode(!0);
                s.autoplay = !1, this.elements.original = s;
                var o = this.media.tagName.toLowerCase(), r = null, l = null;
                switch (o) {
                    case"div":
        ...
        return n(t, [{
            ...
            key: "poster", set: function (e) {
                this.isVideo ? Ee.setPoster.call(this, e, !1).catch(function () {
